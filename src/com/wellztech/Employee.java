...
public class Employee {
    ...
    public Employee(String firstName, String lastName, String ssn, boolean metDeptStaff, boolean movedIn, Date orientationDate) {
    ...
    public void setSsn(String ssn) {
        if(ssn == null || ssn.isEmpty() || ssn.length() < 9){
            throw new IllegalArgumentException("SSN is manditory and must be 9 numbers")
        }
